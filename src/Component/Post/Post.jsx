...
export default function Post({post ,setPosts,activeTab}) {
        ...
        <>
                <div className='post  shadow-md rounded-xl '>
                        ...
                        <PostHeader activeTab={activeTab} setPosts={setPosts} setIsEditing={setIsEditing}  photo={post.user.photo} id={post.id} name={post.user.name} username={post.user.username} createdAt={post.createdAt} privacy={post.privacy} userId={post?.user._id} bookmarked={post.bookmarked}   />
